  ...
  const getCaseDescription = () => {
    switch (caseItem.title) {
      ...
      case 'Cashercollection.com':
        return {
          main: 'Инновационная платформа для управления коллекциями с расширенной API-инфраструктурой. Разработка включает современные подходы к проектированию и реализации сложных бизнес-логик.',
          details: [
      ...
      default:
        return {
          main: 'Профессиональная разработка веб-приложения с использованием современных технологий.',
          details: [],
        }
    }
  }
